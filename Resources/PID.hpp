...
public:
    PIDController(float kp = 1.0f, float ki = 0.0f, float kd = 0.0f, float limit = 16384.0f,float integral_limit = 1000.0f);
    
    // 设置PID参数
    void SetParameters(float kp, float ki, float kd, float limit = 16384.0f,float integral_limit = 1000.0f);
